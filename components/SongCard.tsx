...
import { AuraSongRecommendation } from "@/lib/types";

export default function SongCard({ song }:{ song:AuraSongRecommendation }) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-white/8 bg-white/[.035] p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 text-[10px] font-bold uppercase tracking-wider text-pink-300">{song.reason}</p>
      </div>
